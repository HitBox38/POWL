  ...
  return (
    <SafeAreaView className="flex-1 bg-background">
      <View className="flex-1 items-center justify-center px-6 gap-4">
        ...
        >
          {retried && !retrying
            ? "Saved data is still unavailable. Try again when device storage is available."
            : "Your saved computers will appear here in a moment."}
        </Text>
        <Button
          variant="outline"
          disabled={retrying}
        ...
        >
          <Text>{retrying ? "Loading…" : "Retry loading"}</Text>
        </Button>
      </View>
    </SafeAreaView>
  );
